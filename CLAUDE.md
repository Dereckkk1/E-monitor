...
| Dashboard de veiculação (`/insights`, admin + cliente, KPIs + 4 charts + export PNG/PDF) | [docs/features/insights-dashboard.md](docs/features/insights-dashboard.md) — **os números caíram em 2026-08-17** (executado deixou de somar `out_slot` + fim do double-count do excedente); comparar com relatório antigo não bate, e é o antigo que estava errado |
