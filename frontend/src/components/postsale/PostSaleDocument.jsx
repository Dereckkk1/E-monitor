    ...
    <div className="ps-doc">
      ...
      {campaigns.map((c, i) => (
        <CampaignBlock
          ...
          mapUrlFor={mapUrlFor}
          // O link é do pós-venda inteiro, não da campanha: só o PRIMEIRO bloco
          // recebe, senão o mesmo link se repetiria em cada campanha.
          attachmentsUrl={i === 0 ? attachmentsUrl : null}
        />
      ))}
