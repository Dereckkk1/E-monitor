-- 0029_daily_summary_exclude_audit_rejected.down.sql
-- Restaura a definição da view daily_play_summary anterior à 0029 — sem o
-- filtro `evidence_status <> 'audit_rejected'`. Idêntica à definição da 0020.
