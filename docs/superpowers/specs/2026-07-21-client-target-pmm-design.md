...
> em toda tela e exportável. A premissa central deste spec — "existem hoje três fórmulas diferentes de impactos, e cada tela espelha a própria base" — foi **revogada**: hoje há UMA base canônica (`in_slot + bonus`) em todas as telas.
