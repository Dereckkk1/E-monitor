-- 0041_detection_campaigns.down.sql
-- Reverte F-119 fase 1: restaura daily_play_summary lendo detections direto (0029)
-- e remove a view de compat + a tabela de projeção.

BEGIN;

DROP VIEW IF EXISTS detection_attributions;
DROP VIEW IF EXISTS daily_play_summary;

-- Restaura a daily_play_summary na forma do 0029 (agrega detections direto).
